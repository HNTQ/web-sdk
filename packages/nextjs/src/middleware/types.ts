...
export type WithServerSideAuthCallback<
  Return,
  Options extends WithServerSideAuthOptions
> = (context: ContextWithAuth<Options>) => Return;
...
export type RequestWithAuth<Options extends WithServerSideAuthOptions = any> =
